...
HELMETS = [[20, 2, 12], [17, 8, 18], [11, 10, 13], [7,2,17], [12, 8, 9], [14, 15, 10], [6, 16, 20], [9, 12, 13], [11, 2, 14], [10, 2, 11]]
GLOVES  = [[8, 7, 8], [18, 11, 6], [17, 18, 11], [6, 10, 12], [7, 2, 13], [8, 14, 9], [2, 10, 6], [2, 20, 23]]
BOOTS   = [[14, 2, 18], [10, 11, 10], [6, 19, 10], [6, 13, 7], [6, 6, 6], [15, 6, 26]]
...
def add_boots_stats(helmet_item, gloves_item, total_stat_list):
    ...
    for item in range(no_boots):
        print('For boots number {}: '.format(item+1))
...
def add_gloves_stats(helmet_item, total_stat_list):
    ...
    for item in range(no_gloves):
        print('For gloves number {}: '.format(item+1))
